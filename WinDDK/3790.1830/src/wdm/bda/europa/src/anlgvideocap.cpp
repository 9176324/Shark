...
//
// Description:
//  Creates the Video capture stream object.
...
)
{
    ...
    m_pKSPin              = pKSPin;
    m_dwCurrentFormatSize = pKSPin->ConnectionFormat->FormatSize;
...
//  If existing, the video cature stream and the synchronizing functionality
...
//
//////////////////////////////////////////////////////////////////////////////
NTSTATUS CAnlgVideoCap::Remove
(
    IN PIRP pIrp        //Pointer to IRP for this request. (unused)
)
{
    _DbgPrintF(DEBUGLVL_BLAB,("Info: CAnlgVideoCap::Remove"));
...
//  The 'open' is executed on the video stream object.
...
//
//////////////////////////////////////////////////////////////////////////////
NTSTATUS CAnlgVideoCap::Open
(
)
{
    _DbgPrintF(DEBUGLVL_BLAB,("Info: CAnlgVideoCap::Open"));
    ...
    {
        _DbgPrintF( DEBUGLVL_ERROR,
                    ("Error: Open video capture stream failed"));
        return STATUS_UNSUCCESSFUL;
    }
    return STATUS_SUCCESS;
}
...
//
// Description:
//  Closes the video capture stream object.
//  The 'close' is executed on the video capture stream object.
...
//  STATUS_UNSUCCESSFUL         Operation failed,
//                              (a) the function parameters are zero,
//                              (b) no video capture stream object exists
//                              (c) release vamp buffers failed
//  STATUS_SUCCESS              Closed the video stream object with success
//
//////////////////////////////////////////////////////////////////////////////
NTSTATUS CAnlgVideoCap::Close
(
)
{
    _DbgPrintF(DEBUGLVL_BLAB,("Info: CAnlgVideoCap::Close"));
...
//  The 'start' is executed on the video capture stream object.
//  First the Vamp buffers (NUM_VD_CAP_STREAM_BUFFER) are created
...
//  STATUS_SUCCESS              Started the video capture stream object
//                              with success
//
//////////////////////////////////////////////////////////////////////////////
NTSTATUS CAnlgVideoCap::Start
(
)
{
    _DbgPrintF(DEBUGLVL_BLAB,("Info: CAnlgVideoCap::Start"));
    ...
    {
        _DbgPrintF( DEBUGLVL_ERROR,
                    ("Error: Start video capture stream failed"));
        return STATUS_UNSUCCESSFUL;
    }
...
//  The 'stop' is executed on the video capture stream object.
...
//  STATUS_SUCCESS              Stopped the video capture stream object
//                              with success
//
//////////////////////////////////////////////////////////////////////////////
NTSTATUS CAnlgVideoCap::Stop
(
)
{
    _DbgPrintF(DEBUGLVL_BLAB,("Info: CAnlgVideoCap::Stop"));
    ...
    {
        _DbgPrintF(DEBUGLVL_ERROR,
			("Error: Stop video capture stream failed"));
        return STATUS_UNSUCCESSFUL;
    }
    return STATUS_SUCCESS;
}
...
//
//////////////////////////////////////////////////////////////////////////////
VAMPRET CAnlgVideoCap::CallOnDPC
(
...
)
{
    ...
    if( m_pVampVDStream->AddBuffer(pVampBuffer) != VAMPRET_SUCCESS )
    {
        ...
        m_pSpinLockObj->ReleaseSpinLock(); //void function
        _DbgPrintF( DEBUGLVL_ERROR,
                    ("Error: AddBuffer to capture stream failed"));
        return STATUS_UNSUCCESSFUL;
    }
