...
// Description:
//
//  Analog video preview out pin of the Analog Capture Filter.
//  This class contains the implementation of the preview pin. Within this
...
//
//////////////////////////////////////////////////////////////////////////////
class CAnlgVideoPrev : public CBaseStream, public CBaseClass
{
public:
    CAnlgVideoPrev();
    ~CAnlgVideoPrev();
